...
const Product = () => {
  ...
  return (
    <div className="p-8 min-h-screen">
      <div className="flex flex-col lg:flex-row lg:space-x-8 overflow-hidden">
        ...
        <div className="lg:w-1/3 mt-8 lg:mt-0">
          <BookingForm postDetails={postDetails} />
        </div>
      </div>

      <h1 className="ml-11 font-semibold text-3xl mb-7 mt-12">
        You may like this:
      </h1>
